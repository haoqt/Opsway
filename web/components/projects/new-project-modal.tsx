...
import { X, FolderGit2, Server } from "lucide-react";
      ...
      <div className="w-full max-w-md rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
        <div className="mb-5 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-semibold text-[hsl(var(--foreground))]">New Odoo Project</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          {/* Odoo Configuration — always shown */}
